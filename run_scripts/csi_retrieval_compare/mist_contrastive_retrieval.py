...
model_inputs = [
    {
        "res_dir": "results/csi_contrastive_mist/",
        "save_dir": "results/csi_retrieval_compare/mist_contrastive_retrieval/",
    },
]
...
{cuda_vis_str} python3 src/mist/retrieval_contrast.py \\
    ...
    --hdf-file data/paired_spectra/{dataset_name}/retrieval_hdf/pubchem_with_csi_retrieval_db.h5 \\
